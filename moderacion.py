...
# Configuración de OpenAI Moderation API (se define mediante variable de entorno)
...
def buscar_groseria(texto: str):
    ...
    # 3. Capa Inteligente Multilingüe: OpenAI Moderation API
    ok, razon = moderar_con_openai(texto)
    if not ok:
        return razon
